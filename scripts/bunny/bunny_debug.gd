...
func _process(_dt: float):
	...
	var explore_shape_size = bunny.static_explore_zones[0].area.get_node("CollisionShape3D").shape.size
	explore_zone_mesh.size = explore_shape_size
	explore_zone_box.global_position = bunny.static_explore_zones[0].global_position
